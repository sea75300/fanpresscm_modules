        ...
        <div id="maintab">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-12 col-md-6 fpcm-ui-padding-lg-bottom align-self-center">
                    <?php $theView->textInput('msg[dateFrom]')->setValue(date('Y-m-d', $obj->getStarttime()))->setClass('fpcm-ui-datepicker')->setWrapperClass('fpcm-ui-datepicker-inputwrapper'); ?>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-12 col-md-6 fpcm-ui-padding-lg-bottom align-self-center">
                    <?php $theView->textInput('msg[dateTo]')->setValue(date('Y-m-d', $obj->getStoptime()))->setClass('fpcm-ui-datepicker')->setWrapperClass('fpcm-ui-datepicker-inputwrapper'); ?>
